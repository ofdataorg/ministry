...
The identity is the arms: lion and unicorn supporters, crown, a globe-and-network device with a
bar chart at its foot, and MINISTRY OF DATA set in serif capitals. It is dark ink on a
transparent ground, which is why the site is **light** — the mark cannot exist on a black page,
and a state paper was never printed on one anyway.
...
2. **The arms are the seal.** The crest marks authority — masthead, title page, footer. It is
   never stretched, recoloured, or used as a texture.
